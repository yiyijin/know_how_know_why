 ...
 * 2. 启动作业：bin/flink run -d -m localhost:4000 -c khkw.TopologyChanges /Users/ejin/study/alibaba-sun-jin-cheng/know_how_know_why/khkw/No27-Topology/target/No27-Topology-0.1.jar
 ...
 * 6. bin/flink run -m localhost:4000 -s file:///tmp/chkdir/savepoint-60c27c-c00996801ea6 -c khkw.TopologyChanges /Users/ejin/study/alibaba-sun-jin-cheng/know_how_know_why/khkw/No27-Topology/target/No27-Topology-0.1.jar
 * 预期会恢复失败，需要添加 --allowNonRestoredState 选项, as we remove the side output operator
 ...
 * 9. mvn clean package
 * 10. 启动 bin/flink run -d -m localhost:4000 -c khkw.TopologyChanges /Users/ejin/study/alibaba-sun-jin-cheng/know_how_know_why/khkw/No27-Topology/target/No27-Topology-0.1.jar
 * 11. 创建savepoint并停止作业： bin/flink cancel -s 4ca10c0402ddba3b9455e80bdea7a7bd
 * 12. 修改作业，sourcefunction 增加 key3， 使用version4。
 * 13. 携带--allowNonRestoredState，启动：bin/flink run --allowNonRestoredState -d -m localhost:4000 -s file:///tmp/chkdir/savepoint-1a797f-3022302a6294 --allowNonRestoredState -c khkw.TopologyChanges /Users/ejin/study/alibaba-sun-jin-cheng/know_how_know_why/khkw/No27-Topology/target/No27-Topology-0.1.jar
 * 作者： 孙金城
 * 日期： 2020/6/29
 */
public class TopologyChanges {

    private static final Logger LOG = LoggerFactory.getLogger(TopologyChanges.class);
    ...
    private static void version1(StreamExecutionEnvironment env, OutputTag<Tuple3<String, Integer, Long>> outputTag) {
        ...
        mainResult.getSideOutput(outputTag).print().name("side-output"); // the name will be show up in the UI, that's it, nothing to do with outputTag id
    }
